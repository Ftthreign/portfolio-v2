...
const DEFAULT_PROJECTS: Project[] = [
  {
    ...
    short_description:
      "A multi-platform enterprise design system powering 20+ web and mobile applications with 120+ fluid components.",
    full_description:
      "Aether is an end-to-end design system created for cloud platforms. Built with accessibility, dark/light dynamic tokens, component specs, and motion guidelines.",
    cover_image_url:
  ...
  },
  {
    ...
    short_description:
      "Next-gen real-time financial intelligence dashboard for enterprise traders and wealth managers.",
    full_description:
      "Comprehensive UI/UX overhaul of complex financial visualization dashboards, reducing cognitive load and accelerating execution speed by 40%.",
    cover_image_url:
  ...
  },
  {
    ...
    short_description:
      "Generative AI workspace interface optimizing prompt iteration, canvas collaboration, and asset management.",
    full_description:
      "Designed human-in-the-loop AI interactions and canvas workflows for over 150,000 creative professionals.",
    cover_image_url:
  ...
  },
  {
    ...
    short_description:
      "Cross-platform biometric tracking app with real-time vitals monitoring and offline sync.",
    full_description:
      "Architected high-performance mobile UI components with reactive state synchronization and encrypted offline data storage.",
    cover_image_url:
...
const DEFAULT_POSTS: BlogPost[] = [
  {
    ...
    excerpt:
      "How we created a resilient token structure and component hierarchy that scaled across 15 engineering squads without fragmentation.",
    content:
      "<p>Design systems are culture first, technology second. When scaling across dozens of engineers, key architectural decisions determine whether components stay consistent or fracture.</p><h3>1. Token Foundation</h3><p>Establish semantic color and spatial tokens instead of hardcoded hex values...</p>",
    cover_image_url:
  ...
  },
  {
    ...
    excerpt:
      "Exploring how subtle motion, feedback loops, and spring physics elevate user interfaces from functional to memorable.",
    content:
      "<p>Great interface animation is invisible—it guides attention, builds spatial intuition, and creates emotional resonance without delaying user actions.</p>",
    cover_image_url:
